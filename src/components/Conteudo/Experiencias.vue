...
<template>
    <div
        :class="darkMode == true ? ' bg-gray-900 border-t-4 border-pink-500 sm:py-24 py-6 mx-auto px-3 sm:px-0' : 'px-3 sm:px-0 sm:py-24 py-6 bg-gradient-to-b py-6 from-gray-200 to-pink-300  border-t-4 border-pink-500'">
        <div class="sm:mb-10 mb-6 sm:pl-24">
            <p
                :class="darkMode == true ? 'sm:text-3xl text-xl text-pink-500 font-mono' : 'text-xl sm:text-3xl text-pink-700 font-mono'">
                Experiencias</p>
        </div>
        <div :class="darkMode == true ? 'px-4  flex justify-center' : 'flex justify-center px-4 '">
            <div class="sm:flex sm:justify-center sm:w-fit gap-5 mx-auto">
                <div class="sm:w-2/5">
                    <div
                        :class="darkMode == false ? 'block max-w-sm sm:w-full p-6 bg-pink-600 border border-pink-200 rounded-lg shadow mx-2 sm:mx-0' : 'mx-2 sm:mx-0 sm:w-full  block max-w-sm p-6 border rounded-lg shadow bg-gray-800 border-gray-700 '">
                        <h5
                        ...
                        <p
                            :class="darkMode == true ? 'font-normal text-sm sm:text-base text-gray-400 text-justify' : 'text-justify text-sm sm:text-base font-normal text-blue-100'">
                    ...
                    <div class="sm:pt-48 mt-12 pb-6">
                            <div
                                ...
                                <p
                                    :class="darkMode == true ? 'font-normal text-gray-400 text-justify' : 'font-normal text-blue-100 text-justify'">
                                    {{ propsLanguage.exp.exps[2].descricao }}
                                </p>
                            </div>
                        </div>
                        <div>
                            <p class="text-pink-400 my-3 pl-2 sm:pl-0">{{ propsLanguage.exp.tec }}</p>
                            <ul
                                :class="darkMode == false ? 'flex gap-5 mt-3 px-5 pt-4 pb-2 rounded-md' : 'flex gap-5 mt-3 px-5 pt-4 pb-2 rounded-md'">
                                <li>
                                    <svg xmlns="http://www.w3.org/2000/svg" height="32" width="28" viewBox="0 0 448 512">
                                ...
                                <li>
                                    <svg class="w-7 h-7 text-gray-800 dark:text-white" aria-hidden="true"
                                        ...
                                        :fill="darkMode == true ? 'currentColor' : 'black'" viewBox="0 0 20 20">
                    ...
                    <ol class="relative border-s border-pink-200 dark:border-gray-700">
                        <li class="mb-10 ms-4 sm:pb-64 pb-6">
                            ...
                            <time class="mb-1 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">{{
                                propsLanguage.exp.exps[0].data }}</time>
                            <h3
                        ...
                        <li class="mb-28 ms-4 pb-24">
                            ...
                            <time class="mb-1 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">{{
                                propsLanguage.exp.exps[1].data }}</time>
                            <h3
                                :class="darkMode == true ? 'text-lg font-semibold text-white' : 'text-lg font-semibold text-gray-900'">
                        ...
                        <li class="ms-4 pb-96">
                            ...
                            <time class="mb-1 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">{{
                                propsLanguage.exp.exps[2].data }}</time>
                            <h3
                                :class="darkMode == true ? 'text-lg font-semibold text-white' : 'text-lg font-semibold text-gray-900'">
